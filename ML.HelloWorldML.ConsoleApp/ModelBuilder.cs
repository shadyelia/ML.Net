...
using ML.HelloWorldML.Model.DataModels;
using Microsoft.ML.Trainers;

namespace ML.HelloWorldML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"E:\work\ML.HelloWorld\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../ML.HelloWorldML.Model/MLModel.zip";
